...
from .views import index_view ,contact_view,info_view,triggers_view, symptoms_view,avoid_view,about_view, emergency_view,UserRegisterView, UserLoginView , logout_view, user_images,selfcare_view
